...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($nim == '' || $password == '') {
    ...
    $sqllogin = mysqli_query($konek, "SELECT * from user WHERE nim='$nim' AND password='$password'");
                ...
                <div class="p-5">
                  ...
                  <form method='POST' action="" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="nim" name="nim" aria-describedby="emailHelp" placeholder="Nomor Induk Mahasiswa">
                    </div>
                    <div class="form-group">
