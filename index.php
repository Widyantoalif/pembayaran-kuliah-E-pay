...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Epay</a></h1>
      ...
      <a href="pembayaran/login.php" class="get-started-btn scrollto">Login</a>
      ...
      <div class="row">
        <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div class="mt-3">
            ...
            <a href="pembayaran/register.php" class="btn-get-quote">Register</a>
          </div>
        </div>
